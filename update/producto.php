...
//WHILE
//$consulta = "SELECT * FROM fabricante WHERE id_producto = '$id_producto'";
...
//    ON producto.id_fabricante_id = fabricante.
//id_fabricante WHERE id_producto = '$id_producto'";

$consulta2 ="CALL p_obtenProducto('$id_producto')";
       ...
       <form action="actualizarProducto.php" method="post">
            ...
            <div class="mb-3">
                ...
                <select name="id_fabricante" class="form-select" aria-label="Default select example">
                    ...
                    //$consulta = " CALL p_obtenFabricantes()";
